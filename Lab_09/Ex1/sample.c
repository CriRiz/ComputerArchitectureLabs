...
//Ho scritto le variabili globali in questo modo le posso richiamare con extern nel file IRQ_button.c--
volatile unsigned char current_state = 0b00011101;
volatile unsigned char taps = 0b00011101;
int output_bit;
//------------------------------------------------------------------------------------------------------
