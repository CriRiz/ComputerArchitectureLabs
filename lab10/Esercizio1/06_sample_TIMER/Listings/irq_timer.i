...
void TIMER0_IRQHandler (void)
{
 ...
 //LED_Out((1<<position)|(led_value & 0x3));
  ...
  ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR = 0x3F;
...
{
  ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->IR = 0x3F;
  return;
}
...
void TIMER2_IRQHandler (void)
{
 ...
 if (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->IR & (1 << 0)){ //Resettando l'Interrupt Register ritorna sempre a 0, quindi si possono mettere i due if!S
  LED_Off(pos);
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->IR = 0X3F;
 }

 if (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->IR & (1 << 1)){
  LED_On(pos);
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->IR = 0X3F;
 }
...
void TIMER3_IRQHandler (void)
{
 ...
 if (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR & (1 << 0)){ //Resettando l'Interrupt Register ritorna sempre a 0, quindi si possono mettere i due if!S
  LED_Off(pos);
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR = 0X3F;
 }

 if (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR & (1 << 1)){
  LED_On(pos);
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR = 0X3F;
 }
