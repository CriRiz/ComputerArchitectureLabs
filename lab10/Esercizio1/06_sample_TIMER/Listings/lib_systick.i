# 1 "Source/systick/lib_systick.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 404 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/systick/lib_systick.c" 2
...
# 2 "Source/systick/lib_systick.c" 2
# 1 "Source/systick\\systick.h" 1


void systick_init(uint32_t TimerInterval);
void SysTick_Handler(void);
# 3 "Source/systick/lib_systick.c" 2

void systick_init(uint32_t TimerInterval)
{
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = 0;
 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = TimerInterval;
 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0;
 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = 7;
}
