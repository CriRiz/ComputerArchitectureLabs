...
uint32_t init_timer ( uint8_t timer_num, uint32_t TimerInterval )
{
 //float perc;
  if ( timer_num == 0 )
  {
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR0 = TimerInterval>>1; //PER ACCENDERE LED
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR1 = TimerInterval; //PER SPEGNERE LED
 //((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR2 = TimerInterval * 4;
...
// <i> 0 Feature disabled.
// </e>
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR = 201; //serve per attivare interrupt MR0, MR1, MR2
// </h>
// <<< end of configuration section >>>
 ...
 return (1);
  ...
  else if ( timer_num == 1 ) //ESERCIZIO 2
  {
...
// perc = 0.5; //CAMBIARE
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MR0 = TimerInterval>>1; //PER ACCENDERE LED
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MR1 = TimerInterval; //PER SPEGNERE LED

  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MCR = 25; //serve per attivare interrupt MR0, MR1
...
// perc = 0.5; //CAMBIARE
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR0 = TimerInterval>>1; //PER ACCENDERE LED
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR1 = TimerInterval; //PER SPEGNERE LED

  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MCR = 25; //serve per attivare interrupt MR0, MR1
