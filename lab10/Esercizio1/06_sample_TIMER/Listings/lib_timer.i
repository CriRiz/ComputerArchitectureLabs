...
uint32_t init_timer ( uint8_t timer_num, uint32_t TimerInterval )
{
 float perc;
  if ( timer_num == 0 )
  {
 ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR0 = TimerInterval*perc; //PER ACCENDERE LED
...
// <<< end of configuration section >>>
 ...
 return (1);
  ...
  perc = 0.5; //CAMBIARE
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MR0 = TimerInterval*perc; //PER ACCENDERE LED
  ...
  perc = 0.5; //CAMBIARE
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR0 = TimerInterval*perc; //PER ACCENDERE LED
